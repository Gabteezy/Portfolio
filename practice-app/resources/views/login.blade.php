  ...
  <body class="p-3 m-0 border-0 bd-example m-0 border-0">
    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
      <div class="container-fluid">
        <a class="navbar-brand" href="homepage">First Laravel</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="service1">Services1</a></li>
                <li><a class="dropdown-item" href="service2">Services2</a></li>
                <li><a class="dropdown-item" href="service3">Services3</a></li>
              </ul>
            </li>
            <li class="nav-item">
          ...
          <form class="d-flex" role="search">
            ...
            <button class="btn btn-outline-success" type="submit" fdprocessedid="tl9w4k">Search</button>
          </form>
